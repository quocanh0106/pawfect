...
if (!customElements.get('slider-component')) {
  class SliderComponent extends HTMLElement {
    constructor() {
      ...
      this.enableGallery = this.dataset.gallery === 'true'
      ...
      if(this.enableGallery) {
        this.slider.addEventListener('click', this.showGallery.bind(this))
        this.querySelector('.close').addEventListener('click', this.hideGallery.bind(this))
        this.querySelector('.close-overlay').addEventListener('click', this.hideGallery.bind(this))
      }
    }
    ...
    hideGallery() {
      this.closest('.product-media-wrapper').classList.remove('active')
      this.querySelector('.duplicate-gallery').innerHTML = ''
    }

    showGallery() {
      if(screen.width >= 1024) {
        this.querySelector('.duplicate-gallery').innerHTML = this.querySelector('.main-gallery').innerHTML
      }
      this.closest('.product-media-wrapper').classList.add('active')
    }
